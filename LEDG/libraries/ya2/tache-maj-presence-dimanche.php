...
$requete_maj_presence=" delete from vlxhj_bl_extra_values where f_id=13;";

$mysqli->query($requete_maj_presence);
...
//mail("ya2-95@hotmail.fr","presence",$requete_maj_presence,$tete);
