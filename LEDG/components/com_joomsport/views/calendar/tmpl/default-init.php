...
<!-- <content module> -->
			<div class="content-module padd-off" style="overflow:visible !important;">
				...
				<tr class="<?php echo $i % 2?"":"gray";?>">
					...
					<a href="<?php echo "index.php/fm?tmpl=component&print=1&page=&Num_Match=".$match->id; ?>"/><img src="images/stories/fm-icon.png" title="Feuille de match"></a>
					<?php echo date_bl($match->m_date,$match->m_time)." - ".$match->m_location;?>
					</td>
					<td class="team-ico-h"><!-- -->
					<?php
					...
					<td class="team-a"><a href="<?php echo $link;?>"><?php echo $match->away?></a></td>
					<?php if($lists["locven"]){?>
