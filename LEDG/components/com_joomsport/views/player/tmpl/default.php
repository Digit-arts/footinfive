		...
		<td valign="top" width="100">
				...
				<div class="gray-box">
						...
						if($lists["def_img"] && is_file('media/bearleague/'.$lists["def_img"])){
							...
							echo '<a rel="lightbox-imgsportsingle" href="'.getImgPop($lists["def_img"]).'" class="gray-box-img"><img itemprop="image" src="'.JURI::base().'media/bearleague/'.$lists["def_img"].'" width="'.$width.'" alt="'.$lists["player"]->first_name.'" /></a>';// '.$lists["player"]->last_name.'
						}else{
		...
		<td valign="top">
					<table cellpadding="0" cellspacing="0" border="0" class="adf-fields-table">
						<tr>
							...
							<td nowrap><?php echo $lists["player"]->t_name ; //.' '.$lists["player"]->last_name?></td>
						</tr>
						<tr>
							<td><?php echo JText::_("BL_FIRSTNAME");?>:</td>
...
<div id="etab_stat_div" class="tabdiv" style="display:none;">
				...
				<table class="player-statistic" cellpadding="0" cellspacing="0" border="0">
					 <tr>
						...
						<th>BUTS DU JOUEUR</th>
					</tr>
					<?php
					
						for($i=0;$i<count($lists["stat_match"]);$i++){
							$stats2 = $lists["stat_match"][$i];
							echo "<tr>";
							echo "<td align=center>";
							$date_bly=explode(" ",date_bl($stats2[0],"00:00"));
							echo $date_bly[0];
							echo "</td>";
							echo "<td align=center>";
								 echo $stats2[1];
					...
					for($i=1;$i<count($lists["stat_array"]);$i++){
						$stats = $lists["stat_array"][$i];
						echo "<tr class='dotted'>";
						echo "<th class='dotted' align=center>";
						echo $stats[2];
						echo "</th>";
						echo "<th class='dotted' align=center>";
						echo $stats[0];
						echo "</th>";
						echo "<td class='dotted' align=center>";
						echo $stats[1];
						echo "</td>";
						echo "</tr>";
					}
