...
<div class="control-bar-wr dotted">
	<ul class="control-bar">
		...
		<?php } ?>
		<li><a class="delete" href="<?php echo JRoute::_("index.php?option=com_joomsport&controller=admin&view=adlist_player&sid=".$lists["s_id"]."&Itemid=".$Itemid);?>" title="<?php echo JText::_('BLFA_CLOSE')?>"><?php echo JText::_('BLFA_CLOSE')?></a></li>
...
<?php
		...
		<form action="<?php echo JURI::base();?>index.php?option=com_joomsport&controller=admin&sid=<?php echo $lists["s_id"];?>&Itemid=<?php echo $Itemid;?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		...
		<table class="season-list" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<td>
					...
					<input class="feed-back inp-big" type="text" maxlength="255" size="60" name="first_name" value="<?php echo $row->first_name?>" />
			...
			<tr>
				...
				<td>
					...
					<input  class="feed-back inp-big" type="text" maxlength="255" size="60" name="last_name" value="<?php echo $row->last_name?>" />
			...
			<tr>
				...
				<td>
					<input class="feed-back inp-big" type="text" maxlength="255" size="60" name="nick" value="<?php echo $row->nick?>" />
				</td>
			</tr>
			<tr>
				<td width="100">
		...
		<?php if(!$lists["jssa_editplayer"] && $row->id){}else{?>
		<table style="padding:10px;" class="season-list">
			...
			<tr>
				<td>
					<button class="send-button" onclick="javascript:submitbutton('adplayer_apply');" ><span><?php echo JText::_( 'BLFA_UPLOAD' ); ?></span></button>
				</td>
