...
$sReference = $_GET["ref"];//"ref" . date("His");

// Amount : format  "xxxxx.yy" (no spaces)
$sMontant = $_GET["Montant"];//1.01;
...
<p>
	...
	<!-- -->
	<center><input type="submit" name="bouton"              id="bouton"         value="Connection" /></center>
</p>
</form>
</body>
</html>
