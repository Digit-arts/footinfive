<?php
	 ...
	 *
	 */
	if (is_file('libraries/ya2/fonctions_gestion_user.php') and is_file('libraries/ya2/fonctions_nawi_med.php')){
	...
	set_include_path(get_include_path().PATH_SEPARATOR.JPATH_BASE.'/../ya2');
