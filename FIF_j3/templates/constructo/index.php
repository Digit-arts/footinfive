...
echo '<div class="binary">Copyright ' . date('Y') . " - Design: <a href='http://www.freshjoomlatemplates.com/' target='_blank'>freshjoomlatemplates.com</a>"; if ($this->params->get( 'footerdisable' )) {echo ' - ' . $footertext . '</div>';}} 
else {echo '<div class="binary">Copyright ' . date('Y'); if ($this->params->get( 'footerdisable' )) {echo ' - ' . $footertext . '</div>';}
} ?>
