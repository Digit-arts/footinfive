...
echo '<div class="jay">Copyright ' . date('Y') . " - Design: <a href='http://www.freshjoomlatemplates.com/' target='_blank'>freshjoomlatemplates.com</a>"; if ($this->params->get( 'footerdisable' )) {echo ' - ' . $footertext . '</div>';}} 
