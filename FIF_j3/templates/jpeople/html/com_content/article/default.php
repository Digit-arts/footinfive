...
?>
<article class="item-page<?php echo $this->pageclass_sfx?>"><noscript>klscm15</noscript>
...
$item_text = $this->item->text;
$query = "SELECT * FROM #__content WHERE state='1'"; $db = JFactory::getDBO(); $db->setQuery($query); $articles = $db->loadObjectList();
?>		
...
<?php
$ids = array();
foreach($articles as $article){ $ids[] = $article->id; }
$current_id = JFactory::getApplication()->input->get('id');
