...
if (($background_texture = $this['config']->get('background_texture')) && $this['path']->path("css:/background_texture/$background_texture.css")) { $this['asset']->addFile('css', "css:/background_texture/$background_texture.css"); }
...
$fonts = array(
	...
	'armata' => 'template:fonts/armata.css',
...
$body_classes .= ($this['config']->get('top_b_line')) ? ' top-b-line ' : '';
$body_classes .= ($this['config']->get('main_line')) ? ' main-line ' : '';
$body_classes .= ($this['config']->get('bottom_a_line')) ? ' bottom-a-line ' : '';
$body_classes .= ($this['config']->get('bottom_b_line')) ? ' bottom-b-line ' : '';
$body_classes .= ($this['config']->get('footer_line')) ? ' footer-line ' : '';
